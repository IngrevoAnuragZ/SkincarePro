...
import { EnhancedSkincareRecommendationEngine } from '../lib/enhancedRecommendationEngine';
...
const questions = [
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'aging', text: 'Fine Lines & Wrinkles', value: 'aging' },
      { id: 'hyperpigmentation', text: 'Dark Spots', value: 'hyperpigmentation' },
      { id: 'dryness', text: 'Dryness', value: 'dryness' },
      { id: 'oiliness', text: 'Excess Oil', value: 'oiliness' },
  ...
  },
  {
    ...
    type: 'single' as const,
    answers: [
      { id: 'twenties', text: '20-29 years', value: 'twenties' },
      { id: 'thirties', text: '30-39 years', value: 'thirties' },
      { id: 'forties', text: '40-49 years', value: 'forties' },
      { id: 'fifties-plus', text: '50+ years', value: 'fifties-plus' }
    ]
  },
  {
    id: 'climate',
    ...
    type: 'single' as const,
    answers: [
      { id: 'hot_humid', text: 'Hot and Humid', value: 'hot_humid' },
      { id: 'hot_dry', text: 'Hot and Dry', value: 'hot_dry' },
      { id: 'moderate', text: 'Moderate', value: 'moderate' },
      { id: 'cold', text: 'Cold', value: 'cold' }
    ]
  },
  {
    id: 'experience',
...
const EnhancedAssessmentPage: React.FC = () => {
  ...
  const processAssessment = async (assessmentData: any) => {
    ...
    try {
      ...
      const engine = new EnhancedSkincareRecommendationEngine();
      const enhancedRecommendations = await engine.generateEnhancedRecommendations(
        user?.id || 'anonymous',
        assessmentData,
      ...
      if (user) {
        await saveAssessmentToDatabase(assessmentData);
      ...
      >
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50">
          ...
          {recommendations.recommendations.essential && recommendations.recommendations.essential.length > 0 && (
            <div className="mb-8">
              <h3 className="text-xl font-bold mb-4 text-primary-800">Essential Ingredients</h3>
                  ...
                  >
                    ...
                    {rec.predictedSuccessRate && (
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-primary-500">Success Rate</span>
                        <span className="text-sm font-bold text-primary-700">
                          {Math.round(rec.predictedSuccessRate * 100)}%
                        </span>
                      </div>
                    )}
                  </motion.div>
